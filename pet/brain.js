...
(function (root, factory) {
  ...
  const INTENTS = [
    ['greetingMorning',['おはよ','お早う','朝']], ['greetingDay',['こんにちは','こんちは']], ['greetingNight',['こんばんは','夜']], ['farewell',['ばいばい','またね']], ['reunion',['ひさしぶり','久しぶり','またあえた']],
    ...
    ['play',['遊ぼ','あそぼ','遊ぶ','あそぶ']], ['rest',['休む','やすむ','ひとやすみ']], ['sleep',['寝る','ねる','ねむい','眠い']], ['goodnight',['おやすみ']], ['wake',['起きる','おきる','おきた']], ['thanks',['ありがとう','ありがと']], ['apology',['ごめん','ごめんなさい']], ['praise',['えらい','かわいい','かっこいい']], ['encourage',['がんば','応援','おうえん']], ['laugh',['笑','わら','おもしろい']], ['number',['何個','なんこ','数字','すうじ']], ['choice',['どっち','どちら','選ん']], ['again',['もう一回','もういっかい','もっかい']], ['unknownQuestion',['どうして','なぜ','知ってる']], ['recall',['覚えて','おぼえて','忘れ']], ['petMood',['元気','げんき','気分','きぶん']], ['favorite',['好きなもの','すきなもの','お気に入り']], ['followWhy',['どうして？','なんで？']], ['followLike',['それ好き？','すき？']], ['followAgain',['もういっかい？','もう一回？']]
  ...
  const STYLE_BY_INTENT = { playful:new Set(['happy','bored','play','animal','color','music','picture','outdoors','laugh','number','choice']), calm:new Set(['sad','angry','scared','tired','rest','sleep','goodnight','apology','weather','cold']), talkative:new Set(['greetingMorning','greetingDay','greetingNight','reunion','askPetName','askChildName','food','book','thanks','praise','encourage','recall','petMood','favorite']) };
