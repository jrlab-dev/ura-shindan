(() => {
  ...
  function initialize() {
    ...
    /* 見本ページではオフライン保存を使わない（本番 /pet/ の保存と混ざらないようにするため） */
  }
